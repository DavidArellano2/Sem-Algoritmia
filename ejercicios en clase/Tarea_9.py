...
#A continuación esta el algoritmo de PRIM, el alogritmo lo saque de la siguiente pagina
# https://gist.github.com/davcastroruiz/f7e041ac68970d339176c0be4631d07b
...
#4. Tomar vertice de la lista ordenada y eliminarlo
    vertice = listaOrdenada.pop(0)
    d = vertice[1]

#5. Si el destino no esta en la lista de visitados
    if not isInTheList(d,listaVisitados):
#6. Agregar a la lista el nodo destino
        listaVisitados.append(d)
#7. Agregar a la lista los aydacentes del nodo destino
...
#8. Agregar vertice al nodo resultante
...
for arista in resultado:
    cv2.line(th2, tuple(arista[0]), tuple(arista[1]), (0, 0, 255), 3)
